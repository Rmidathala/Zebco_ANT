...
msgEmptyCompareSection("//div[@class='message-success success message']/div",XPATH,"Product Listing Page - Clear All Compare Section"),
...
msgProductAddedToCompare("//div[@class='message-success success message']/div",XPATH,"Product Listing Page - Message - Product added to Compare - You added product # to the comparison list."),
btnProductWishList("//div[@class='actions-secondary']/a[1]",XPATH,"Product Listing page Button - Wish"),
msgProductAddedToWishList("//div[@class='message-success success message']/div",XPATH,"Product Listing Page - Message - Product added to Wish List - "),
...
msgproductRemovedFromWishList("//div[@class='message-success success message']/div",XPATH,"Product Listing page - Message - 'Product' has been removed from your Wish List."),
