...
public enum ProductDetailsPageObjects implements PageObjects{
	...
	productMainStarRating("(//div[@class='pr-rating-stars'])[1]",XPATH,"Product Details Page - Product Main Rating in Stars"),
	productRatingInNumber("(//div[@class='pr-snippet-rating-decimal'])[1]",XPATH,"Product Details Page - Product Main Rating in Decimal"),
	ProductReviewCountlink("//a[@class='pr-snippet-review-count']",XPATH,"Product Details Page - Product Review Count Link"),
	writeAReviewLink("(//a[@class='pr-snippet-write-review-link'])[1]",XPATH,"Product Details Page - Product Write a Review Link"),
