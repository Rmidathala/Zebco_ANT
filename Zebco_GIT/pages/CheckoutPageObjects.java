...
public enum CheckoutPageObjects  implements PageObjects {
	...
	txtBoxNameOnCard("//*[@id='c-cardname']",XPATH,"Name on credit card"),
	txtBoxCreditCard("//*[@id='c-cardnumber']",XPATH,"Payment Page - Credit Card Number text box"),
	drpDownExpiryMonth("//*[@id='c-exmth']",XPATH,"Payment Page - Expiry Month Drop Down"),
	drpDonwExpiryYear("//*[@id='c-exyr']",XPATH,"Payment page - Expiry Year Drop Down"),
	txtBoxCVV("//*[@id='c-cvv']",XPATH,"Payment Page - CVV text Box"),
